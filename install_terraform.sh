#Get Terraform
version=terraform_0.11.5_linux_amd64.zip
wget "https://releases.hashicorp.com/terraform/0.11.5/$version"
unzip $version -d ~/
rm $version
cd /usr/bin
...
wget "https://github.com/oracle/terraform-provider-oci/releases/download/v2.1.2/linux_amd64.tar.gz"
